...
- **Test counts are quoted on deck slide 8, so re-measure before quoting them.**
  Re-measured 11 Aug 2026: **126 shared + 129 backend = 255 TypeScript tests**, plus 191
  ...
  scanner and the reset were deleted, then climbed back to 129 with the denial
  and directory work — so a count copied from an older section is wrong in
  whichever direction that section is old. They had drifted to "97 / 105 / 202",
  and again to "114 / 120 / 234", and nothing caught either, because
