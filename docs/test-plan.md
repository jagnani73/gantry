...
**One fix awaiting your re-test.** **F22** at #57 — the denial receipt's remedy
card claimed a payment was still refused right after the payer had allowed it.
Same stale array as F21 and F4; fixed for all three at once by moving the
reconciliation into the store.

**Not yet driven:** Phases 9-11, and #58-#59. Phases 1-7 are complete; Phase 8
is driven through #57.
...
| 57  | Save, reopen the receipt                          | Now reads **"Your rules have changed since"**                                                                                   | **FAIL -> F22, fixed, MUST BE RE-RUN.** The reopened receipt still read *Still refused today* seconds after the payer had widened the very rule that refused it; a page refresh fixed it. Re-run: reopen the receipt straight after the save and it must read *Your rules have changed since* with no refresh |
